...
proc create_root_design { parentCell } {
  ...
  # Create instance: BUFF_FULL, and set properties
  set BUFF_FULL [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 BUFF_FULL ]
  ...
  # Create instance: UART_TX, and set properties
  set UART_TX [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 UART_TX ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
  ...
  # Create instance: UARTmodule2020_0, and set properties
  set UARTmodule2020_0 [ create_bd_cell -type ip -vlnv user.org:user:UARTmodule2020:1.0 UARTmodule2020_0 ]
  set_property -dict [ list \
   CONFIG.BAUDRATE {"00011100001000000000"} \
   CONFIG.FREQUENCY {000101111101011110000100000000} \
 ] $UARTmodule2020_0
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports leds_4bits] [get_bd_intf_pins LED/GPIO]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins UART_TX/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins BUFF_FULL/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]

  # Create port connections
  connect_bd_net -net UARTmodule2020_0_tx [get_bd_ports tx_0] [get_bd_pins UARTmodule2020_0/tx]
  connect_bd_net -net UARTmodule2020_0_tx_full [get_bd_pins BUFF_FULL/gpio_io_i] [get_bd_pins UARTmodule2020_0/tx_full]
  connect_bd_net -net axi_gpio_1_gpio2_io_o [get_bd_pins UART_TX/gpio2_io_o] [get_bd_pins UARTmodule2020_0/write_to_uart]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins UART_TX/gpio_io_o] [get_bd_pins UARTmodule2020_0/tx_data]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins BUFF_FULL/s_axi_aclk] [get_bd_pins LED/s_axi_aclk] [get_bd_pins UART_TX/s_axi_aclk] [get_bd_pins UARTmodule2020_0/clock] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins BUFF_FULL/s_axi_aresetn] [get_bd_pins LED/s_axi_aresetn] [get_bd_pins UART_TX/s_axi_aresetn] [get_bd_pins UARTmodule2020_0/reset] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x41210000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs UART_TX/S_AXI/Reg] -force
  assign_bd_address -offset 0x41220000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs BUFF_FULL/S_AXI/Reg] -force

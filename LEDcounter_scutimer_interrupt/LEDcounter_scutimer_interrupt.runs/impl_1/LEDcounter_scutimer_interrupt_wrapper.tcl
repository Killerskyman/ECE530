...
set rc [catch {
  ...
  open_checkpoint C:/xup/LEDcounter_scutimer_interrupt/LEDcounter_scutimer_interrupt.runs/impl_1/LEDcounter_scutimer_interrupt_wrapper.dcp
  ...
  set_property ip_repo_paths c:/xup/LEDcounter_scutimer_interrupt/LEDcounter_scutimer_interrupt.cache/ip [current_project]
  set_property ip_output_repo c:/xup/LEDcounter_scutimer_interrupt/LEDcounter_scutimer_interrupt.cache/ip [current_project]

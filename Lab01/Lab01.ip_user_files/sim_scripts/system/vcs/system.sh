...
#
# Generated by Vivado on Thu Dec 02 23:51:49 EST 2021
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../Lab01.srcs/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Lab01.srcs/sources_1/bd/system/ipshared/2d50/hdl" +incdir+"$ref_dir/../../../../Lab01.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" +incdir+"/tools/Xilinx/Vivado/2019.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../Lab01.srcs/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Lab01.srcs/sources_1/bd/system/ipshared/2d50/hdl" +incdir+"$ref_dir/../../../../Lab01.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" +incdir+"/tools/Xilinx/Vivado/2019.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../Lab01.srcs/sources_1/bd/system/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work axi_vip_v1_1_6 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../Lab01.srcs/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Lab01.srcs/sources_1/bd/system/ipshared/2d50/hdl" +incdir+"$ref_dir/../../../../Lab01.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" +incdir+"/tools/Xilinx/Vivado/2019.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../Lab01.srcs/sources_1/bd/system/ipshared/dc12/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work processing_system7_vip_v1_0_8 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../Lab01.srcs/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Lab01.srcs/sources_1/bd/system/ipshared/2d50/hdl" +incdir+"$ref_dir/../../../../Lab01.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" +incdir+"/tools/Xilinx/Vivado/2019.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../Lab01.srcs/sources_1/bd/system/ipshared/2d50/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

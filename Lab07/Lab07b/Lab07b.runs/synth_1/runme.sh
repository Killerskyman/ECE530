...
HD_PWD='/home/skillet/git/ECE530/Lab07/Lab07b/Lab07b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interrupt_counter_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interrupt_counter_wrapper.tcl

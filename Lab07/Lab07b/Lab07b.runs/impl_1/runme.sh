...
HD_PWD='/home/skillet/git/ECE530/Lab07/Lab07b/Lab07b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log interrupt_counter_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source interrupt_counter_wrapper.tcl -notrace

...
//#define HDMI_BASEADDR XPAR_AXI_DISPCTRL_0_S_AXI_BASEADDR
#define VGA_VDMA_ID XPAR_AXIVDMA_0_DEVICE_ID
//#define HDMI_VDMA_ID XPAR_AXIVDMA_0_DEVICE_ID
//#define AUDIO_IIC_ID XPAR_XIICPS_0_DEVICE_ID
//#define AUDIO_CTRL_BASEADDR XPAR_PS7_I2C_0_BASEADDR
...
//	AudioInitialize(SCU_TIMER_ID, AUDIO_IIC_ID, AUDIO_CTRL_BASEADDR);
	...
	while (userInput != 'q')
	{
		...
		/* Store the first character in the UART recieve FIFO and echXPAR_PS7_UART_1_BASEADDRo it */

set_property SLEW FAST [get_ports {BLUE_O[4]}]
set_property SLEW FAST [get_ports {BLUE_O[3]}]
set_property SLEW FAST [get_ports {BLUE_O[2]}]
set_property SLEW FAST [get_ports {BLUE_O[1]}]
set_property SLEW FAST [get_ports {BLUE_O[0]}]
set_property SLEW FAST [get_ports {GREEN_O[5]}]
set_property SLEW FAST [get_ports {GREEN_O[4]}]
set_property SLEW FAST [get_ports {GREEN_O[3]}]
set_property SLEW FAST [get_ports {GREEN_O[2]}]
set_property SLEW FAST [get_ports {GREEN_O[1]}]
set_property SLEW FAST [get_ports {GREEN_O[0]}]
set_property SLEW FAST [get_ports {RED_O[4]}]
set_property SLEW FAST [get_ports {RED_O[3]}]
set_property SLEW FAST [get_ports {RED_O[2]}]
set_property SLEW FAST [get_ports {RED_O[1]}]
set_property SLEW FAST [get_ports {RED_O[0]}]

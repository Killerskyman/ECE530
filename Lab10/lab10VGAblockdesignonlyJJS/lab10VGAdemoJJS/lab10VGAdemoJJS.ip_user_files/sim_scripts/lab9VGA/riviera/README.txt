...
#
# Generated by export_simulation on Fri Jan 28 11:40:31 EST 2022
#
################################################################################
...
'-reset_run' switch to the './lab9VGA.sh' script.

./lab9VGA.sh -reset_run
...
./lab9VGA.sh -noclean_files

For more information on the script, please type './lab9VGA.sh -help'.
